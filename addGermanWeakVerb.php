...
echo "Adding German weak verb '" . $stem . PHP_EOL;
$inf = $stem . '(en)';
// present indicative
$s1 = '(ich) ' . $stem . 'e';
$s2 = '(du) ' . $stem . 'st';
...
$psts1 = '(ich) ' . $stem . 'te';
$psts2 = '(du) ' . $stem . 'test';
$psts3 = '(er/sie/es) ' . $stem . 'te';
$pstp1 = '(wir) ' . $stem . 'ten';
$pstp2 = '(ihr) ' . $stem . 'tet';
$pstp3 = '(sie) ' . $stem . 'ten';
// past subjunctive
$pstsbj = $stem . 'te-';
$pstsbjs1 = '(... ich) ' . $stem . 'te';
$pstsbjs2 = '(... du) ' . $stem . 'test';
$pstsbjs3 = '(... er/sie/es) ' . $stem . 'te';
$pstsbjp1 = '(... wir) ' . $stem . 'ten';
$pstsbjp2 = '(... ihr) ' . $stem . 'tet';
$pstsbjp3 = '(... sie) ' . $stem . 'ten';
...
$db->exec($sql, array(":wordform" => $inf, ":lang"=>"de", ":gloss"=>"", ":morphosyntax"=>"weak verb", ":notes"=>""));
...
SQL;
$results = $db->fetch($sql, array(":wf" => $inf, ":lang" => "de", ":ms" => "weak verb"));
$infid = $results[0]['id'];
